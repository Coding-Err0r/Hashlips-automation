...
const baseUri = prompt(
  'Enter the ipfs base url like (ipfs://000000...): '
); //'ipfs://NewUriToReplace';
let numberOfGeneratedImages = prompt(
  'Enter The Number Of Images You Like To Generate : '
);
...
logTimer(() => {
  layerConfigurations.push({
    growEditionSizeTo: numberOfGeneratedImages,
